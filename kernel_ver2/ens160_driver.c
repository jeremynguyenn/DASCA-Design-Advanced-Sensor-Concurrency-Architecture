...
static void sample_data(struct work_struct *work) {
    ...
    // CRC check cho AHT21 (datasheet formula: CRC = 0xFF - sum(bytes0-5) + 1)
...
// Có thể thêm RCU cho lock-free reads nếu dùng liburcu (V.15), Kalman filter cho data fusion (V.18)