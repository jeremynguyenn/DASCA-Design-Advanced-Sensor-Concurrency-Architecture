...
#define QUEUE_MAX 100 // Bổ sung: Threshold cho circuit breaker
...
// Bổ sung: Define cleanup_handler (mention trong user_main.c)
    ...
    while (1) {
        ...
        for (int n = 0; n < nfds; n++) {
            if (events[n].data.fd == tfd) {
                ...
                // Bổ sung: Circuit breaker cho rate limit (V.20)
